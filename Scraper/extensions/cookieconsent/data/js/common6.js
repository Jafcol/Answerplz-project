function getE(h)
{
	switch (h)
	{
		...
		case 'euroclear.com': return ['cc_necessary=true', 'cc_functional=true'];
		...
		case 'lg.com': return ['toppop=done'];
		...
		case 'my.minecraft.net': var d = Math.round(Date.now()/1000); return ['MSCC=' + (d - d % 86400)];
